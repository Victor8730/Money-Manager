            ...
            <form action="{{ route('income.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Date:</strong>
                            <input type="date" class="form-control datepicker" name="create_at" id="create_at">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <button type="submit" class="btn btn-success tooltip-show" title="Click this button to create a new income">Create new income</button>
                    </div>
                </div>
            </form>
        </div>
